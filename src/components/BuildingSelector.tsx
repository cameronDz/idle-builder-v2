...
function BuildingCard({
  ...
  const isDisabled = count >= config.maxCount || !affordable;
  ...
  return (
    ...
    >
      ...
      <div className={styles.info}>
        ...
        <span className={`${styles.cost} ${!affordable ? styles.cantAfford : ''}`}>
          ...
          {!affordable && <span className={styles.cantAffordLabel}>{" Can't afford"}</span>}
        </span>
      </div>
